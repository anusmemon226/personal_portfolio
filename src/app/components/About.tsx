        ...
        <div className="w-[50%] max-md:w-[100%] bg-slate-50 px-8 flex flex-col justify-center py-5">
          ...
          <div>
            ...
            <div className="flex flex-row items-center gap-3 py-2">
                <AboutIcon title="Linkedin" link="https://www.linkedin.com/in/muhammadanus226/"/>
                <AboutIcon title="Github" link="https://github.com/anusmemon226"/>
                <AboutIcon title="Whatsapp" link="https://wa.link/ytr8aa"/>    
            </div>
          </div>
          {/* <div className="mt-4">
