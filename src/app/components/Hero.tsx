    ...
    <div ref={ref} className="flex justify-between px-6 max-4sm:px-0 sm:px-16 md:px-10 lg:px-20 bg-slate-50 relative">
      <div className="flex w-[50%] max-4sm:w-[100%] max-lg:w-[100%] max-lg:bg-white/20 max-5sm:bg-white/30 flex-col justify-center max-2sm:my-[3.5rem] max-3sm:my-[6rem] max-4sm:my-[5.5rem] max-5sm:my-[3.5rem] my-[4.8rem] sm:my-[5.2rem] px-2 max-4sm:px-3 z-10 break-words">
        ...
        <div className="5sm:w-max py-3">
          <h1 className="text-[30px] max-3sm:text-[20px] max-4sm:text-[18px] 5sm:animate-typing max-5sm:text-[20px] 5sm:overflow-hidden max-5sm:text-wrap text-black 5sm:whitespace-nowrap 5sm:border-r-4 5sm:border-r-black 5sm:pr-5">A Freelance Web Developer</h1>
        </div>
      ...
      <div
        className={`sm:w-[90%] w-[100%] h-[100%] bg-profilePic bg-50% bg-bottom sm:bg-contain bg-no-repeat sm:bg-right-bottom absolute left-0 top-1 md:top-0`}
      ></div>
    </div>
  );
}
