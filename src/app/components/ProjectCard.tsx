...
const ProjectCard = ({ projectName, projectDescription }: { projectName: string, projectDescription: string }) => {
    return (
        <Link href={"/"} className="group aspect-square rounded-lg shadow-lg overflow-hidden">
            <div className="bg-[url('/project.jpg')] bg-cover bg-center flex flex-col items-center justify-center relative w-full h-full before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gradient-to-tl before:from-black before:to-transparent before:hover:bg-black before:hover:opacity-75 before:transition-all before:duration-150">
